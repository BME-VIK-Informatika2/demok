    ...
    <table class="table">
        ...
        <?php foreach ($termekek as $termek): ?>
            <tr>
                ...
                <td><?= $termek->nev ?></td>
                <td
                    <?= $termek->keszlet() < 0 ? 'class="text-danger fw-bold"' : '' ?>
                ><?= $termek->megrendeles_tetelek()->sum('db') ?> / <?= $termek->raktarkeszlet ?></td>
                <td><a href="megrendelesek.php?termek_id=<?= $termek->id ?>">Megrendelés</a></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
